    ...
    return (
        <div className="h-auto w-screen container mx-auto text-center py-10">
            ...
            <div className="grid lg:grid-cols-7 md:grid-cols-4 sm:grid-cols-2 h-auto mx-4 gap-4 ">
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "All Food" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Burger" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Pizza" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Sandwich" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Cold Drinks" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Pasta" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
                ...
                <button
                    className={`rounded-xl flex flex-col items-center justify-center p-2 ${selectedCategory === "Combo" ? "bg-[#ff0000] text-white" : "border border-gray-500"}`}
