...
export default function OrderFood() {
    const menuData = [
        ...
        },
        {
          ...
          {
            img: "/assets/pepperoni-pizza.jpeg",
          ...
          {
            img: "/assets/bbq-chicken-pizza.jpg",
        ...
        },
        {
          ...
          {
            img: "/assets/grilled-bbq-chicken.jpg",
          ...
          {
            img: "/assets/crispy-fried-chicken.jpg",
          ...
          {
            img: "/assets/tandoori-chicken.jpg",
          ...
          {
            img: "/assets/grilled-whole-chicken.jpg",
            title: 'Grilled Chicken',
          ...
          {
            img: "/assets/grilled-chicken-sandwich.jpg",
          ...
          {
            img: "/assets/veggie-sandwich.jpg",
          ...
          {
            img: "/assets/seafood-platter.jpg",
          ...
          {
            img: "/assets/dessert-platter1.jpg",
          ...
          {
            img: "/assets/Red-Bull-Energy-Drink.jpeg",
            title: 'Red Bull',
            ...
            <div className="bg-opacity-90 bg-gray-100">
                <div className="h-auto w-screen container mx-auto text-center py-10 ">
                    ...
                    <div className="grid lg:grid-cols-7 md:grid-cols-4 grid-cols-2 h-auto mx-4 gap-4 ">
                        ...
                        >
                            <img src="/assets/combo3.png" alt="combo" className="h-20 w-fit" />
                            <span>All Food</span>
                        </button>
                        ...
                        >
                            <img src="/assets/burger1.png" alt="burger" className="h-20 w-fit" />
                            <span>Burger</span>
                        </button>
                        <button
                        ...
                        >
                            ...
                            <img src="/assets/pizza.png" alt="Pizza" className="h-16 w-fit" />
                            <span>Pizza</span>
                        </button>
                        <button
                        ...
                        >
                            <img src="/assets/sandwich1.png" alt="sandwich" className="h-20 w-fit" />
                            <span>Sanwich</span>
                        </button>
                        <button
                        ...
                        >
                            <img src="/assets/cocacola1.png" alt="cocacola" className="h-20 w-fit" />
                            <span>Drinks</span>
                        </button>
                        <button
                        ...
                        >
                            <img src="/assets/pasta1.png" alt="Pasta" className="h-20 w-fit" />
                            <span>Pasta</span>
                        </button>
                        <button
                        ...
                        >
                            <img src="/assets/combo2.png" alt="combo" className="h-20 w-fit" />
                            <span>Combo</span>
                        </button>
                    </div>
