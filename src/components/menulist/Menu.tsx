                ...
                {filteredMenuData.slice(0, visibleItems).map((menu, index) => (
                    <Link to={`/foodDetails/${menu.title}`} key={index}>
                        ...
                        >
                            ...
                            <button className='w-full border border-[#515151] py-2 rounded-3xl font-semibold flex items-center justify-center gap-2 hover:bg-[#000] hover:text-white transition-all'>
                                <LocalMallIcon />
                                Add to Cart
                            </button>
                        </div>
